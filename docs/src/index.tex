...
\newcommand\doactionref[1]{\hyperref[hyper][action\_#1]{\bitt{#1}}\index{#1}\endgroup}

\newcommand\blockref{\begingroup \catcode`_=12 \doblockref}
\newcommand\doblockref[1]{\hyperref[hyper][block\_#1]{\bitt{#1}}\index{#1}\endgroup}

\newcommand\clientref{\begingroup \catcode`_=12 \doclientref}
\newcommand\doclientref[1]{\hyperref[hyper][client\_#1]{\bitt{#1}}\index{#1}\endgroup}
