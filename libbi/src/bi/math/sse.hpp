 ...
 * $Date$
 */
#ifndef BI_MATH_SSE_HPP
#define BI_MATH_SSE_HPP
...
#endif
#else
#define BI_SSE_SIZE 1
#endif

#if defined(USE_SSE) and !defined(__CUDACC__)
#include <pmmintrin.h>
...
#define BI_SSE_ROTATE_LEFT(x) BI_SSE_SHUFFLE_P(x, x, _MM_SHUFFLE(2,3,0,1))
#else
...
#define BI_SSE_ROTATE_LEFT(x) BI_SSE_SHUFFLE_P(x, x, _MM_SHUFFLE(3,2,1,0))
#endif
#define BI_SSE_PREFETCH _mm_prefetc
