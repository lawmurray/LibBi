 ...
 * $Date$
 */
#ifndef BI_CUDA_UPDATER_DYNAMICLOGDENSITYKERNEL_CUH
#define BI_CUDA_UPDATER_DYNAMICLOGDENSITYKERNEL_CUH

#include "../cuda.hpp"

namespace bi {
/**
 * Kernel function for dynamic log-density evaluation.
 *
 * @tparam B Model type.
...
CUDA_FUNC_GLOBAL void kernelDynamicLogDensity(const T1 t1, const T1 t2,
    State<B,ON_DEVICE> s, V1 lp);

}

#include "DynamicLogDensityMatrixVisitorGPU.cuh"
#include "DynamicLogDensityVisitorGPU.cuh"
