...
Bi is set up to use the Eclipse IDE. From a vanilla install of the Eclipse IDE
...
A custom code style is available in the \bitt{custom\_code\_style.xml} file,
...
transformations made by GenBi, by using the \clientref{rewrite} command.
