...
A \bitt{dim} statement may only be used at the top level of a \kwref{model}
...
These statements may only be used at the top level of a \kwref{model}
statement. Dimensions along which a variable extends must be declared
prior to the declaration of the variable, using the \kwref{dim} statement.
