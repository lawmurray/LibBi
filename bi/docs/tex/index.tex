...
\newenvironment{tip}
{\vspace{\baselineskip}\marginlabel{Tip $\rightarrow$}\vspace{-1.4\baselineskip}\begin{mdframed}[linewidth=0.4pt,skipabove=\baselineskip,innertopmargin=0]\begin{minipage}{\textwidth}}
