...
LibBi consists of three components:
\begin{description}
...
\section{The LibBi modelling language\label{Modelling_language}}
...
Input data is provided to LibBi in the format of NetCDF\index{NetCDF} files. The
