...
$CPPINCLUDES = "-I$Bin/../../lib/src -I/tools/cuda/4.0/cuda/include/ -I/usr/local/cuda/include -I/tools/magma/1.0.0rc5/include -I/usr/local/atlas/include";
...
$LINKFLAGS = "-L\"$Bin/../../lib/build\" -L\"/tools/cuda/4.0/cuda/lib64\" -L\"/tools/magma/1.0.0rc5/cuda4.0/lib\" -L\"/tools/boost/1.43.0/lib\" -lbi -lmagma -lmagmablas -lqrupdate -lgfortran -lnetcdf_c++ `nc-config --libs` -lpthread";
