 ...
 * $Date$
 */
#ifndef BI_CUDA_UPDATER_DYNAMICMAXLOGDENSITYGPU_CUH
#define BI_CUDA_UPDATER_DYNAMICMAXLOGDENSITYGPU_CUH

#include "../../state/State.hpp"

namespace bi {
/**
 * Dynamic max log-density updater, on device.
 *
...
template<class B, class S>
template<class T1, class V1>
void bi::DynamicMaxLogDensityGPU<B,S>::maxLogDensities(const T1 t1, const T1 t2,
