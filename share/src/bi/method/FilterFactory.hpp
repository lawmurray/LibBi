...
template<class B, class S, class R, class S2>
bi::Filter<bi::AdaptivePF<B,S,R,S2> >* bi::FilterFactory::createAdaptivePF(B& m,
    S& sim, R& resam, S2& stopper) {
  return new Filter<AdaptivePF<B,S,R,S2> >(m, sim, resam, stopper);
}
