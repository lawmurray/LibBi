...
$CPPINCLUDES = '-Isrc -I/tools/cuda/4.0/cuda/include/ -I/usr/local/cuda/include -I/usr/local/include/thrust -I/tools/magma/1.0.0rc5/include -I/usr/local/atlas/include';
